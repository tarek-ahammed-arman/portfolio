...
const About = () => {
  ...
  const features = [
    {
      icon: <Shield className="h-6 sm:h-7 w-6 sm:w-7 text-accent-foreground" />,
    ...
    {
      icon: <Code className="h-6 sm:h-7 w-6 sm:w-7 text-accent-foreground" />,
    ...
    {
      icon: <BookOpen className="h-6 sm:h-7 w-6 sm:w-7 text-accent-foreground" />,
